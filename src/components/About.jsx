        ...
        <article className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="animate-fadeIn">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="flex bg-white p-4 rounded-lg shadow-sm animate-fadeIn" style={{ animationDelay: "1s" }}>
              ...
              <div className="flex bg-white p-4 rounded-lg shadow-sm animate-fadeIn" style={{ animationDelay: "1.2s" }}>
                <div className="flex-shrink-0 mr-3">
                  <svg className="h-6 w-6 text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="flex bg-white p-4 rounded-lg shadow-sm animate-fadeIn" style={{ animationDelay: "1.4s" }}>
                <div className="flex-shrink-0 mr-3">
                  <svg className="h-6 w-6 text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="flex bg-white p-4 rounded-lg shadow-sm animate-fadeIn" style={{ animationDelay: "1.6s" }}>
                <div className="flex-shrink-0 mr-3">
                  <svg className="h-6 w-6 text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
