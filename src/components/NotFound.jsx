...
function NotFound() {
  useEffect(() => {
    document.title = "404 - Halaman Tidak Ditemukan | Kost Ash-Shaff"
  }, [])
  ...
  return (
    <div className="error-page">
      <div className="main">
        <div>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 355">
            ...
            <g id="tracks">
              {/* Track paths - simplified from original */}
              {Array.from({ length: 30 }, (_, i) => (
                <path key={`track-${i}`} className="st2" d={`M${i * 20} 282.4h-3L${i * 20 - 6.8} 307.6h3z`} />
              ))}
              {Array.from({ length: 30 }, (_, i) => (
                <path key={`track-back-${i}`} className="st2" d={`M${1000 - i * 20} 282.4h-3L${1000 - i * 20 - 6.8} 307.6h3z`} />
              ))}
      ...
      <div className="error-content">
        <h1>Kamu Tersesat!</h1>
        <p>Halaman yang kamu cari sepertinya telah berpindah atau tidak pernah ada.</p>
