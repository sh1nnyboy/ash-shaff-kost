      ...
      <div className="container-custom">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Jangan ragu untuk menghubungi kami untuk informasi lebih lanjut atau untuk memesan kamar
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center text-center">
              ...
              <a
                href="mailto:fusiodabanna@gmail.com"
                className="text-emerald-600 hover:text-emerald-700"
              >
          ...
          <div className="mt-12 p-8 bg-emerald-50 rounded-xl border border-emerald-100">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="mb-6 md:mb-0 text-center md:text-left">
                <h3 className="text-2xl font-semibold text-gray-800 mb-2">Mau Booking Kamar?</h3>
                <p className="text-gray-600">
                  Hubungi kami sekarang untuk memesan atau melihat kamar secara langsung
                </p>
              </div>
              <a
                href="https://wa.me/6285868015805"
